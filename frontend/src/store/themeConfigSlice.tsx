...
const initialState = {
    ...
    menu: 'collapsible-vertical' || themeConfig.menu,
    ...
    auth2FA : localStorage.getItem('auth2FA') || themeConfig.auth2FA,
    notifications: [],
    infoData: [],
...
const themeConfigSlice = createSlice({
    ...
    reducers: {
        ...
        setCurrentAlertLocation(state, { payload }) {
            state.currentAlertLocation = payload || {};
        },
        ...
        setLoader(state, { payload }) {
            state.loader = payload || false;
        },

        setResetAlert(state, { payload }) {
            state.resetAlert = payload || false;
        },
...
export const { toggleTheme, toggleMenu, toggleLayout, toggleRTL, toggleAnimation, toggleNavbar, toggleSemidark, toggleLocale, toggleSidebar, setPageTitle, setNotifications, setInfoData, setCurrentAlertLocation, setBreadCrumb, setLoader, setResetAlert, setUserDetails } = themeConfigSlice.actions;
