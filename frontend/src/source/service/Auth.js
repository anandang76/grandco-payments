...
export const PasswordForgot = async (data) => {
    try {
        return await Client.post(themeConfig?.apiURL+"auth/forgotPassword", data);
    } catch (e) {
        console.error(e);
        return e;
    }
...
export const UserPasswordChange = async (data) => {
    try {
        return await Client.post(themeConfig?.apiURL+"users/changePassword", data);
    } catch (error) {
        console.error(error);
        return error;
    }
...
export const LogOut = async (data) => {
    try {
        return await Client.post(themeConfig?.apiURL+"auth/logout", data);
    } catch (error) {
        console.error(error);
        return error;
    }
