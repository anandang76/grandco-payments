...
import { GetCategories, DeleteCategory } from "@/source/service/DeviceManagementService";
...
const DeviceCategory = () => {
    ...
    const ConfirmDelete = async (id: any) => {
        let message: string = 'Unable to delete device category';
        let status: string = 'error';

        let response = await DeleteCategory({
            categoryID: id
        });
    ...
    return (
        <div>
            <div className="flex md:items-center md:flex-row flex-col mb-5 gap-5">
                <h5 className="font-semibold text-lg dark:text-white">CATEGORY</h5>
