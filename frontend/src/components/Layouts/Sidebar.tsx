...
import { setBreadCrumb, toggleSidebar } from '../../store/themeConfigSlice';
...
import IconUndoLeft from '../Icon/IconUndoLeft';
import IconMonitorSmartphone from '../Icon/IconMonitorSmartphone';
import IconTablet from '../Icon/IconTablet';
import DefaultLogo from "../../source/assets/images/Janane_Logo.png";
import collapsableIcon from "../../assets/image.png";
import IconGraphNewUp from '../Icon/IconGraphNewUp';
        ...
        <div className={semidark ? 'dark' : ''}>
            <nav className={`sidebar fixed min-h-screen h-full top-0 bottom-0 w-[260px] shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] z-50 transition-all duration-300 ${semidark ? 'text-white-dark' : ''}`}>
                <div className="bg-white dark:bg-black h-full">
                    <div className={`flex justify-around items-center ${themeConfig.sidebar ? 'px-8' : 'px-3'} py-3`}>
                        <NavLink to="/dashboard" onClick={HandleDashboard} className="main-logo flex items-center shrink-0 w-fit">

                            {themeConfig.sidebar ?
                                <img className='flex-none' src={CurrentLogo || DefaultLogo} alt="logo" />
                                :
                                <img className='flex-none' src={collapsableIcon} alt="logo" />
                            }
                        </NavLink>
                        <button
                            type="button"
                    ...
                    <PerfectScrollbar className="h-[calc(100vh-80px)] relative">
                        <ul className="relative font-semibold space-y-0.5 p-4 py-0">
                            ...
                            <li className="nav-item">
                                <NavLink to="/dashboard" onClick={HandleDashboard} className="group">
                                    <div className="flex items-center">
                                        <IconMenuDashboard className="group-hover:!text-primary shrink-0" />
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-white dark:group-hover:text-white-dark">{t('dashboard')}</span>
                                    </div>
                                </NavLink>
                            </li>
                            {userRole != 'user' && <li className="nav-item">
                                <NavLink to="/user" className="group">
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-white dark:group-hover:text-white-dark">{t('User')}</span>
                                    </div>
                                </NavLink>
                            </li>}
                            {userRole != 'user' && <li className="nav-item">
                            ...
                            <li className="nav-item">
                                <NavLink to="/change-password" className="group">
                                    <div className="flex items-center">
                                        <IconUndoLeft className="group-hover:!text-primary shrink-0" />
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-white dark:group-hover:text-white-dark">{t('Change password')}</span>
                                    </div>
                                </NavLink>
                            </li>
                            ...
                            {userRole != 'user' && <>
                                <h2 className="py-3 px-7 flex items-center uppercase font-extrabold bg-white-light/30 dark:bg-dark dark:bg-opacity-[0.08] -mx-4 mb-1">
                                    <span>{t('Configuration Management')}</span>
                                </h2>
                                <li className="nav-item">
                                    <NavLink to="/device-config" className="group">
                                        <div className="flex items-center">
                                            <IconMonitorSmartphone className="group-hover:!text-primary shrink-0" />
                                            <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-white dark:group-hover:text-white-dark">{t('Device Config')}</span>
                                        </div>
                                    </NavLink>
                                </li>
                                <li className="nav-item">
                                    <NavLink to="/email-config" className="group">
                                        <div className="flex items-center">
                                            <IconMail className="group-hover:!text-primary shrink-0" />
                                            <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-white dark:group-hover:text-white-dark">{t('Email Config')}</span>
                                        </div>
                                    </NavLink>
                                </li>
                            </>}
                            ...
                            {(userRole != 'admin' && userRole != 'user') && <>
                                ...
                                <li className="nav-item">
                                    <NavLink to="/device-management" className="group">
                                        <div className="flex items-center">
                                            <IconTablet className="group-hover:!text-primary shrink-0" />
                                            <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-white dark:group-hover:text-white-dark">{t('Devices')}</span>
                                        </div>
                                    </NavLink>
                                </li>
                            </>}
