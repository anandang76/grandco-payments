...
//Project routes
const Login = lazy(() => import('../source/auth/Login'));
const SignUp = lazy(() => import('../source/auth/SignUp'));
const ForgetPassword = lazy(() => import('../source/auth/ForgetPassword'));
const ResetPassword = lazy(() => import('../source/auth/ResetPassword'));

const Dashboard = lazy(() => import('../source/pages/Dashboard/Dashboard'));
const Device = lazy(() => import('../source/pages/Devices/Devices'));
const Sensor = lazy(() => import('../source/pages/Sensors/Sensors'))
const User = lazy(() => import('../source/pages/User/User'));
const Report = lazy(() => import('../source/pages/Report/Report'));
const Trends = lazy(() => import('../source/pages/Trends/Trends'));
const ChangePassword = lazy(() => import('../source/pages/ChangePassword/ChangePassword'));
const DeviceConfigLocation = lazy(() => import('../source/pages/DeviceConfig/Location/Location'));
const DeviceConfigBranch = lazy(() => import('../source/pages/DeviceConfig/Branch/Branch'));
const DeviceConfigFacility = lazy(() => import('../source/pages/DeviceConfig/Facility/Facility'));
const DeviceConfigBuilding = lazy(() => import('../source/pages/DeviceConfig/Building/Building'));
const DeviceConfigFloor = lazy(() => import('../source/pages/DeviceConfig/Floor/Floor'));
const DeviceConfigZone = lazy(() => import('../source/pages/DeviceConfig/Zone/Zone'));
const DeviceConfigDevice = lazy(() => import('../source/pages/DeviceConfig/Device/Device'));
const DeviceConfigSensor = lazy(() => import('../source/pages/DeviceConfig/Sensor/Sensor'));
const DeviceManagement = lazy(() => import('../source/pages/DeviceManagement/DeviceManagement'));
const EmailConfig = lazy(() => import('../source/pages/EmailConfig/EmailConfig'));
const AddSensor = lazy(() => import('../source/pages/DeviceConfig/Sensor/Component/AddSensor'))
...
const routes = [
    ...
    {
        path: 'device-config',
        element: <DeviceConfigLocation />
    },
    {
        path: 'device-config/:locationID',
        element: <DeviceConfigBranch />
    },
    {
        path: 'device-config/:locationID/:branchID',
        element: <DeviceConfigFacility />
    },
    {
        path: 'device-config/:locationID/:branchID/:facilityID',
        element: <DeviceConfigBuilding />
    },
    {
        path: 'device-config/:locationID/:branchID/:facilityID/:buildingID',
        element: <DeviceConfigFloor />
    },
    {
        path: 'device-config/:locationID/:branchID/:facilityID/:buildingID/:floorID',
        element: <DeviceConfigZone />
    },
    {
        path: 'device-config/:locationID/:branchID/:facilityID/:buildingID/:floorID/:zoneID',
        element: <DeviceConfigDevice />
    },
    {
        path: 'device-config/:locationID/:branchID/:facilityID/:buildingID/:floorID/:zoneID/:deviceID',
        element: <DeviceConfigSensor />
    },
    {
        path: 'sensor/:locationID/:branchID/:facilityID/:buildingID/:floorID/:zoneID/:deviceID',
        element: <AddSensor />
    },
    {
        path: 'sensor/:locationID/:branchID/:facilityID/:buildingID/:floorID/:zoneID/:deviceID/:sensorID',
        element: <AddSensor />
    },
    {
